    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetHeader className="sr-only">
          ...
          <SheetDescription>Menampilkan bilah samping di ponsel.</SheetDescription>
        </SheetHeader>
        <SheetContent
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">Buka atau tutup bilah samping</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label="Buka atau tutup bilah samping"
      tabIndex={-1}
      onClick={toggleSidebar}
      title="Buka atau tutup bilah samping"
      className={cn(
