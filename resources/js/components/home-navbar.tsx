        ...
        <header className="border-b border-[#E8EEF8] bg-white px-5 sm:px-8 lg:px-12">
            <div className="mx-auto flex min-h-16 max-w-[1356px] items-center gap-6">
                <Link
                    ...
                    aria-label="BRI Peduli home"
                >
                    <GraduationCap
                        className="size-11 fill-[#105BDD] text-[#105BDD]"
                        strokeWidth={1.5}
                    />
                    <span className="leading-none">
                        <strong className="block text-[25px] font-extrabold tracking-[-1.5px] text-[#105BDD]">
                            BRI Peduli
                        </strong>
                        <small className="mt-1 block text-[11px] font-medium text-[#60709A]">
                ...
                >
                    ...
                    <Link
                        href="/courses"
                        className={`flex items-center gap-1 border-b-2 py-[22px] text-[14px] font-semibold ${isCourses ? 'border-[#105BDD] text-[#071457]' : 'border-transparent text-[#50618C] hover:text-[#105BDD]'}`}
                    >
                        Kelas <ChevronDown size={14} />
                    </Link>
                    {['Tentang Kami', 'Untuk Institusi', 'Blog', 'Kontak'].map(
                        (item) => (
                            <a
                                key={item}
                                href="#"
                                className="text-[14px] font-medium text-[#50618C] hover:text-[#105BDD]"
                            >
                                {item}
                            </a>
                        ),
