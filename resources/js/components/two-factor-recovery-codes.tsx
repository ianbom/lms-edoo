    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Kode pemulihan membantu kamu masuk kembali jika kehilangan
                    perangkat 2FA. Simpan di pengelola password yang aman.
                </CardDescription>
            </CardHeader>
            <CardContent>
                            ...
                            <>
                                ...
                                <div className="text-muted-foreground text-xs select-none">
                                    <p id="regenerate-warning">
                                        ...
                                        sekali untuk mengakses akunmu, lalu akan
                                        dihapus. Kalau butuh kode baru, klik{' '}
