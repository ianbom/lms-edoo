...
export default function AuthSimpleLayout({
    ...
    return (
        <main className="min-h-[100dvh] bg-[#FBFCFF] lg:grid lg:grid-cols-[minmax(0,1.05fr)_minmax(460px,0.95fr)]">
            <section
                className="relative hidden overflow-hidden bg-[#1054D0] p-10 text-white lg:flex lg:flex-col lg:justify-between xl:p-16"
                aria-hidden="true"
            >
                <div className="absolute -top-24 -right-24 size-96 rounded-full border border-white/15" />
                ...
                <div className="relative max-w-xl space-y-8">
                    ...
                    <h1 className="max-w-lg text-4xl leading-[1.08] font-semibold tracking-tight xl:text-6xl">
                        Bangun keterampilan yang membawa Anda lebih jauh.
                    </h1>
                    <p className="max-w-md text-base leading-7 text-white/75">
                        Akses kelas terarah, materi praktis, dan pembelajaran
                        yang bisa Anda lanjutkan kapan saja.
                    </p>
                    <div className="grid gap-3 text-sm text-white/85">
                        <div className="flex items-center gap-3">
                            <CheckCircle2 className="size-5 text-[#DCECFC]" />
                ...
                <p className="relative text-sm text-white/55">
                    Platform pembelajaran untuk langkah berikutnya.
                </p>
            </section>
            ...
            <section className="flex min-h-[100dvh] items-center justify-center px-5 py-10 sm:px-8">
                <div className="w-full max-w-[410px]">
                    ...
                    >
                        ...
                        <span className="font-semibold text-[#070B49]">
                            {name}
                        </span>
                    </Link>
